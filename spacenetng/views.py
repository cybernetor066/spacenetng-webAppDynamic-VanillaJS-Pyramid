...
class HomeViews(object):
    ...
    def homepage(self):
        # *****************************************************
        # fetch data from electronics collection
        # Operation1
        ElectronicsViewProductsViews(object).electronics_viewProducts2_page1B()
        # Operation2
        electronics_productID1 = resData_electronics['productID1']
        electronics_username1 = resData_electronics['username1']
        electronics_state1 = resData_electronics['state1']
        electronics_city1 = resData_electronics['city1']
        electronics_description1 = resData_electronics['description1']
        electronics_mobile1 = resData_electronics['mobile1']
        electronics_email1 = resData_electronics['email1']
        electronics_category1 = resData_electronics['category1']
        electronics_condition1 = resData_electronics['condition1']
        electronics_image1A = resData_electronics['image1A']
        electronics_image1B = resData_electronics['image1B']
        electronics_image1C = resData_electronics['image1C']
        electronics_image1D = resData_electronics['image1D']
        electronics_image1E = resData_electronics['image1E']
        
        # *****************************************************
        # fetch data from automobiles collection
        # Operation1
        AutomobilesViewProductsViews(object).automobiles_viewProducts2_page1B()
        # Operation2
        automobiles_productID1 = resData_automobiles['productID1']
        automobiles_username1 = resData_automobiles['username1']
        automobiles_state1 = resData_automobiles['state1']
        automobiles_city1 = resData_automobiles['city1']
        automobiles_description1 = resData_automobiles['description1']
        automobiles_mobile1 = resData_automobiles['mobile1']
        automobiles_email1 = resData_automobiles['email1']
        automobiles_category1 = resData_automobiles['category1']
        automobiles_condition1 = resData_automobiles['condition1']
        automobiles_image1A = resData_automobiles['image1A']
        automobiles_image1B = resData_automobiles['image1B']
        automobiles_image1C = resData_automobiles['image1C']
        automobiles_image1D = resData_automobiles['image1D']
        automobiles_image1E = resData_automobiles['image1E']

        # *****************************************************
        # fetch data from housing collection
        # Operation1
        HousingViewProductsViews(object).housing_viewProducts2_page1B()
        # Operation2
        housing_productID1 = resData_housing['productID1']
        housing_username1 = resData_housing['username1']
        housing_state1 = resData_housing['state1']
        housing_city1 = resData_housing['city1']
        housing_description1 = resData_housing['description1']
        housing_mobile1 = resData_housing['mobile1']
        housing_email1 = resData_housing['email1']
        housing_category1 = resData_housing['category1']
        housing_condition1 = resData_housing['condition1']
        housing_image1A = resData_housing['image1A']
        housing_image1B = resData_housing['image1B']
        housing_image1C = resData_housing['image1C']
        housing_image1D = resData_housing['image1D']
        housing_image1E = resData_housing['image1E']

        # *****************************************************
        # fetch data from fashion collection
        # Operation1
        FashionViewProductsViews(object).fashion_viewProducts2_page1B()
        # Operation2
        fashion_productID1 = resData_fashion['productID1']
        fashion_username1 = resData_fashion['username1']
        fashion_state1 = resData_fashion['state1']
        fashion_city1 = resData_fashion['city1']
        fashion_description1 = resData_fashion['description1']
        fashion_mobile1 = resData_fashion['mobile1']
        fashion_email1 = resData_fashion['email1']
        fashion_category1 = resData_fashion['category1']
        fashion_condition1 = resData_fashion['condition1']
        fashion_image1A = resData_fashion['image1A']
        fashion_image1B = resData_fashion['image1B']
        fashion_image1C = resData_fashion['image1C']
        fashion_image1D = resData_fashion['image1D']
        fashion_image1E = resData_fashion['image1E']
...
class ElectronicsViewProductsViews(object):
    ...
    def electronics_viewProducts2_page1B(self):
        ...
        electronics_collection = text_collection.find().sort([("_id", pymongo.DESCENDING)]).limit(25) #This returns 25 records
        ...
        document6 = electronics_collection_list[5]
        document7 = electronics_collection_list[6]
        document8 = electronics_collection_list[7]
        document9 = electronics_collection_list[8]
        document10 = electronics_collection_list[9]
        document11 = electronics_collection_list[10]
        document12 = electronics_collection_list[11]
        document13 = electronics_collection_list[12]
        document14 = electronics_collection_list[13]
        document15 = electronics_collection_list[14]
        document16 = electronics_collection_list[15]
        document17 = electronics_collection_list[16]
        document18 = electronics_collection_list[17]
        document19 = electronics_collection_list[18]
        document20 = electronics_collection_list[19]
        document21 = electronics_collection_list[20]
        document22 = electronics_collection_list[21]
        document23 = electronics_collection_list[22]
        document24 = electronics_collection_list[23]
        document25 = electronics_collection_list[24]
        ...
        for image_name in document1["Images"]:
            document1_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document2["Images"]:
            document2_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document3["Images"]:
            document3_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document4["Images"]:
            document4_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document5["Images"]:
            document5_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document6["Images"]:
            document6_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document7["Images"]:
            document7_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document8["Images"]:
            document8_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document9["Images"]:
            document9_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document10["Images"]:
            document10_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document11["Images"]:
            document11_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document12["Images"]:
            document12_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document13["Images"]:
            document13_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document14["Images"]:
            document14_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document15["Images"]:
            document15_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document16["Images"]:
            document16_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document17["Images"]:
            document17_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document18["Images"]:
            document18_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document19["Images"]:
            document19_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document20["Images"]:
            document20_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document21["Images"]:
            document21_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document22["Images"]:
            document22_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document23["Images"]:
            document23_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document24["Images"]:
            document24_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
        ...
        for image_name in document25["Images"]:
            document25_images_list_rawFile.append(image_collection.get_last_version(filename=image_name))
...
class AutomobilesViewProductsViews(object):
    ...
    def automobiles_viewProducts2_page1B(self):
        ...
        # Retrieve document record from database operation
        automobiles_collection = text_collection.find().sort([("_id", pymongo.DESCENDING)]).limit(25) #This returns 25 records
        ...
        document6 = automobiles_collection_list[5]
        document7 = automobiles_collection_list[6]
        document8 = automobiles_collection_list[7]
        document9 = automobiles_collection_list[8]
        document10 = automobiles_collection_list[9]
        document11 = automobiles_collection_list[10]
        document12 = automobiles_collection_list[11]
        document13 = automobiles_collection_list[12]
        document14 = automobiles_collection_list[13]
        document15 = automobiles_collection_list[14]
        document16 = automobiles_collection_list[15]
        document17 = automobiles_collection_list[16]
        document18 = automobiles_collection_list[17]
        document19 = automobiles_collection_list[18]
        document20 = automobiles_collection_list[19]
        document21 = automobiles_collection_list[20]
        document22 = automobiles_collection_list[21]
        document23 = automobiles_collection_list[22]
        document24 = automobiles_collection_list[23]
        document25 = automobiles_collection_list[24]
...
class HousingViewProductsViews(object):
    ...
    def housing_viewProducts2_page1B(self):
        ...
        # Retrieve document record from database operation
        housing_collection = text_collection.find().sort([("_id", pymongo.DESCENDING)]).limit(25) #This returns 25 records
        ...
        document6 = housing_collection_list[5]
        document7 = housing_collection_list[6]
        document8 = housing_collection_list[7]
        document9 = housing_collection_list[8]
        document10 = housing_collection_list[9]
        document11 = housing_collection_list[10]
        document12 = housing_collection_list[11]
        document13 = housing_collection_list[12]
        document14 = housing_collection_list[13]
        document15 = housing_collection_list[14]
        document16 = housing_collection_list[15]
        document17 = housing_collection_list[16]
        document18 = housing_collection_list[17]
        document19 = housing_collection_list[18]
        document20 = housing_collection_list[19]
        document21 = housing_collection_list[20]
        document22 = housing_collection_list[21]
        document23 = housing_collection_list[22]
        document24 = housing_collection_list[23]
        document25 = housing_collection_list[24]
...
class FashionViewProductsViews(object):
    ...
    def fashion_viewProducts2_page1B(self):
        ...
        # Retrieve document record from database operation
        fashion_collection = text_collection.find().sort([("_id", pymongo.DESCENDING)]).limit(25) #This returns 25 records
        ...
        document6 = fashion_collection_list[5]
        document7 = fashion_collection_list[6]
        document8 = fashion_collection_list[7]
        document9 = fashion_collection_list[8]
        document10 = fashion_collection_list[9]
        document11 = fashion_collection_list[10]
        document12 = fashion_collection_list[11]
        document13 = fashion_collection_list[12]
        document14 = fashion_collection_list[13]
        document15 = fashion_collection_list[14]
        document16 = fashion_collection_list[15]
        document17 = fashion_collection_list[16]
        document18 = fashion_collection_list[17]
        document19 = fashion_collection_list[18]
        document20 = fashion_collection_list[19]
        document21 = fashion_collection_list[20]
        document22 = fashion_collection_list[21]
        document23 = fashion_collection_list[22]
        document24 = fashion_collection_list[23]
        document25 = fashion_collection_list[24]
